                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="/" class="d-block">
                                                    <img src="{{ asset('assets/images/virals-logo.png') }}" alt="" height="18">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">" Cảm ơn bạn đã sử dụng dịch vụ của chúng tôi "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Mọi thắc mắc hay liên hệ hợp tác vui lòng liên hệ"</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Zalo 0775713230 TELEGRAM giao686 "</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- end carousel -->
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Đăng ký để khám phá thêm dịch vụ của chúng tôi</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form class="needs-validation" novalidate action="register" method="post">
                                                ...
                                                <div id="password-contain" class="p-3 bg-light mb-2 rounded">
                                                    ...
                                                    <p id="pass-lower" class="invalid fs-12 mb-2">Chứa <b>kí tự</b> từ (a-z)</p>
                                                    <p id="pass-upper" class="invalid fs-12 mb-2">Có 1 <b> kí tự in hoa</b> từ (A-Z)</p>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Đã có tài khoản ? <a href="login" class="fw-semibold text-primary text-decoration-underline"> Đăng nhập</a> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> giaodaica <i class="mdi mdi-heart text-danger"></i> giaodaica
                            </p>
                        </div>
                    </div>
                </div>
