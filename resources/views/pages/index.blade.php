                    ...
                    <div class="col-lg-8 col-sm-10">
                        ...
                        <div class="mt-4 mt-sm-5 pt-sm-5 mb-sm-n5 demo-carousel">
                            <div class="demo-img-patten-top d-none d-sm-block">
                                <img src="{{ asset('build/assets/images/landing/img-pattern.png') }}" class="d-block img-fluid" alt="...">
                            </div>
                         ...
                         <div class="carousel slide carousel-fade" data-bs-ride="carousel">
                            <div class="carousel-inner shadow-lg p-2 bg-white rounded">
                                <div class="carousel-item active" data-bs-interval="2000">
                                    <img src="{{ asset('build/assets/images/products/img-1.png') }}" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ asset('build/assets/images/products/img-2.png') }}" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ asset('build/assets/images/products/img-3.png') }}" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ asset('build/assets/images/products/img-4.png') }}" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ asset('build/assets/images/products/img-5.png') }}" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ asset('build/assets/images/products/img-6.png') }}" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ asset('build/assets/images/products/img-7.png') }}" class="d-block w-100" alt="...">
                                </div>
                            </div>
                        </div>
                        @else
                            <div class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner shadow-lg p-2 bg-white rounded">
                                    <div class="carousel-item active" data-bs-interval="2000">
                                        <img src="{{ asset('build/assets/images/demos/default.png') }}" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item" data-bs-interval="2000">
                                        <img src="{{ asset('build/assets/images/demos/saas.png') }}" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item" data-bs-interval="2000">
                                        <img src="{{ asset('build/assets/images/demos/material.png') }}" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item" data-bs-interval="2000">
                                        <img src="{{ asset('build/assets/images/demos/minimal.png') }}" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item" data-bs-interval="2000">
                                        <img src="{{ asset('build/assets/images/demos/creative.png') }}" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item" data-bs-interval="2000">
                                        <img src="{{ asset('build/assets/images/demos/modern.png') }}" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item" data-bs-interval="2000">
                                        <img src="{{ asset('build/assets/images/demos/interactive.png') }}" class="d-block w-100" alt="...">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="text-center mt-5">
                            <h5 class="fs-20">Được phát triển bởi</h5>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="client-images">
                                            <b>Trần Trung Hiếu</b>
                                            <img src="{{ asset('build/assets/images/clients/trantrunghieu.jpg') }}" alt="client-img" class="mx-auto img-fluid d-block" width="200">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="client-images">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="mb-3 ff-secondary fw-semibold lh-base">Ở đây chỉ bán kiến thức không bán LAB,ASSIGNMENT</h1>
                            <p class="text-muted">Ở đây chúng tôi có thể hỗ trợ bạn hầu hết các vấn đề </p>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
                ...
                <div class="row g-3">
                    <div class="col-lg-4">
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="fs-18">Thiết kế với figma</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="fs-18">Nghiệp vụ dự án</h5>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item carousel-item-next carousel-item-start">
            <img class="d-block img-fluid mx-auto" src="{{ asset('build/assets/images/products/img-1.png') }}" alt="First slide">
        </div>
        <div class="carousel-item">
            <img class="d-block img-fluid mx-auto" src="{{ asset('build/assets/images/products/img-2.png') }}" alt="Second slide">
        </div>
        <div class="carousel-item active carousel-item-start">
            <img class="d-block img-fluid mx-auto" src="{{ asset('build/assets/images/products/img-3.png') }}" alt="Third slide">
        </div>
    </div>
</div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text-muted">
                            ...
                            <h3 class="mb-3 fs-20">Ứng dụng mua sắm hàng đầu</h3>
                            <p class="mb-4 ff-secondary fs-16">Khám phá ngay ứng dụng mua sắm của sự tiện lợi! Với các tiện ích thông minh, bạn sẽ dễ dàng lướt qua bộ sưu tập sản phẩm hot nhất: từ những chiếc áo thun cá tính, bộ đồ dùng nhà bếp hiện đại, đến các món đặc sản thơm ngon từ khắp nơi. Chỉ cần một cú chạm, mọi thứ bạn cần đều nằm trong tầm tay – mua sắm chưa bao giờ nhanh chóng và thú vị đến thế!</p>
  ...
  <section class="section bg-light py-5" id="features">
    <div class="container">
        <div class="row align-items-center gy-4">
            <div class="col-lg-6 col-sm-7 mx-auto">
                <div>
                    <img src="{{ asset('build/assets/images/landing/features/img-1.png') }}" alt="" class="img-fluid mx-auto">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="text-muted">
   ...
   <section class="section" id="contact">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center mb-5">
                    <h3 class="mb-3 fw-semibold">Sản Phẩm</h3>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="text-center my-2">
                                        <a href="shop" class="btn btn-success"><i class="mdi mdi-spin fs-20 align-middle me-2"></i> Xem Thêm </a>
                                    </div>
                                </div>
                            </div>
                            <!-- end row -->
                ...
                <div class="container">
                    <div class="row align-items-center gy-4">
                        <div class="col-lg-6 order-2 order-lg-1">
                            <div class="text-muted">
                                <h5 class="fs-12 text-uppercase text-success">Thiết Kế</h5>
                                <h4 class="mb-3">Quản trị tốt với</h4>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="vstack gap-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-14 mb-0">Thương mại điện tử</h5>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-14 mb-0">Nhà hàng</h5>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-14 mb-0">Khách sạn</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="vstack gap-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-14 mb-0">Trường học</h5>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-14 mb-0">Quản lý</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-sm-7 col-10 ms-auto order-1 order-lg-2">
                            <div>
                                <img src="{{ asset('build/assets/images/landing/features/img-2.png') }}" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="row align-items-center mt-5 pt-lg-5 gy-4">
                        <div class="col-lg-6 col-sm-7 col-10 mx-auto">
                            <div>
                                <img src="{{ asset('build/assets/images/landing/features/img-3.png') }}" alt="" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="text-muted ps-lg-5">
                                <h5 class="fs-12 text-uppercase text-success">Cấu trúc</h5>
                                <h4 class="mb-3">Tài liệu tốt</h4>
                                ...
                                <div class="vstack gap-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <p class="mb-0">Nội dung hấp dẫn</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <p class="mb-0">Thiết lập thông tin</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <p class="mb-0">Tùy chỉnh giao diện</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="process-card mt-4">
                                <div class="process-arrow-img d-none d-lg-block">
                                    <img src="{{ asset('build/assets/images/landing/process-arrow-img.png') }}" alt="" class="img-fluid">
                                </div>
            ...
            <section class="section bg-light" id="team">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="text-center mb-5">
                                <h3 class="mb-3 fw-semibold"> <span class="text-danger">Thành Viên</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    <div class="avatar-xl mx-auto mb-4 position-relative">
                                        <img src="{{ asset('build/assets/images/users/trantrunghieu.jpg') }}" alt="" class="img-fluid rounded-circle">
                                    ...
                                    <!-- end card body -->
                                    <h5 class="mb-1"><a href="pages-profile.html" class="text-body">Trần Trung Hiếu</a></h5>
