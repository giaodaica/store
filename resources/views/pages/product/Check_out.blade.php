                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="pills-payment" role="tabpanel" aria-labelledby="pills-payment-tab">
                                        ...
                                        <div data-bs-toggle="collapse" data-bs-target="#paymentmethodCollapse.show" aria-expanded="false" aria-controls="paymentmethodCollapse">
                                            <div class="form-check card-radio">
                                                ...
                                                <label class="form-check-label" for="paymentMethod03">
                                                    ...
                                                    <span class="fs-14 no-wrap">Thanh toán khi nhận hàng</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-start gap-3 mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-label right ms-auto nexttab" data-nexttab="pills-finish-tab"><i class="ri-shopping-basket-line label-icon align-middle fs-16 ms-2"></i>Complete Order</button>
                                </div>
                            </div>
                            <!-- end tab pane -->
                        </div>
